...
#include "CustomQmitkLabelSetWidget.h"
...
CustomQmitkLabelSetWidget::CustomQmitkLabelSetWidget(QWidget *parent)
...
CustomQmitkLabelSetWidget::~CustomQmitkLabelSetWidget() {}

void CustomQmitkLabelSetWidget::OnTableViewContextMenuRequested(const QPoint & /*pos*/)
{
...
void CustomQmitkLabelSetWidget::OnUnlockAllLabels(bool /*value*/)
{
  GetWorkingImage()->GetActiveLabelSet()->SetAllLabelsLocked(false);
  mitk::RenderingManager::GetInstance()->RequestUpdateAll();
}

void CustomQmitkLabelSetWidget::OnLockAllLabels(bool /*value*/)
{
  GetWorkingImage()->GetActiveLabelSet()->SetAllLabelsLocked(true);
  mitk::RenderingManager::GetInstance()->RequestUpdateAll();
}

void CustomQmitkLabelSetWidget::OnSetAllLabelsVisible(bool /*value*/)
{
  GetWorkingImage()->GetActiveLabelSet()->SetAllLabelsVisible(true);
  UpdateAllTableWidgetItems();
}

void CustomQmitkLabelSetWidget::OnSetAllLabelsInvisible(bool /*value*/)
{
  GetWorkingImage()->GetActiveLabelSet()->SetAllLabelsVisible(false);
  UpdateAllTableWidgetItems();
}

void CustomQmitkLabelSetWidget::OnSetOnlyActiveLabelVisible(bool /*value*/)
{
...
void CustomQmitkLabelSetWidget::OnMergeLabel(bool /*value*/)
{
...
void CustomQmitkLabelSetWidget::OnEraseLabel(bool /*value*/)
{
  int pixelValue = GetPixelValueOfSelectedItem();
...
void CustomQmitkLabelSetWidget::OnRemoveLabel(bool /*value*/)
{
  int pixelValue = GetPixelValueOfSelectedItem();
...
void CustomQmitkLabelSetWidget::OnRenameLabel(bool /*value*/)
{
  int pixelValue = GetPixelValueOfSelectedItem();
...
void CustomQmitkLabelSetWidget::OnCombineAndCreateMask(bool /*value*/)
{
  m_Controls.m_LabelSetTableWidget->selectedRanges();
  // ...to do... //
}

void CustomQmitkLabelSetWidget::OnCreateMasks(bool /*value*/)
{
  m_Controls.m_LabelSetTableWidget->selectedRanges();
  // ..to do.. //
}

void CustomQmitkLabelSetWidget::OnCombineAndCreateSurface(bool /*value*/)
{
  m_Controls.m_LabelSetTableWidget->selectedRanges();
  // ..to do.. //
}

void CustomQmitkLabelSetWidget::OnEraseLabels(bool /*value*/)
{
...
void CustomQmitkLabelSetWidget::OnRemoveLabels(bool /*value*/)
{
...
void CustomQmitkLabelSetWidget::OnMergeLabels(bool /*value*/)
{
  int pixelValue = GetPixelValueOfSelectedItem();
...
void CustomQmitkLabelSetWidget::OnLockedButtonClicked()
{
  int row = -1;
  for (int i = 0; i < m_Controls.m_LabelSetTableWidget->rowCount(); ++i)
  {
...
void CustomQmitkLabelSetWidget::OnVisibleButtonClicked()
{
  int row = -1;
  for (int i = 0; i < m_Controls.m_LabelSetTableWidget->rowCount(); ++i)
  {
...
void CustomQmitkLabelSetWidget::OnColorButtonClicked()
{
  int row = -1;
  for (int i = 0; i < m_Controls.m_LabelSetTableWidget->rowCount(); ++i)
  {
...
void CustomQmitkLabelSetWidget::OnRandomColor(bool /*value*/)
{
  int pixelValue = GetPixelValueOfSelectedItem();
  GetWorkingImage()
    ->GetLabel(pixelValue, GetWorkingImage()->GetActiveLayer())
...
void CustomQmitkLabelSetWidget::SetOrganColors(const QStringList &organColors)
{
  m_OrganColors = organColors;
}

void CustomQmitkLabelSetWidget::OnActiveLabelChanged(int pixelValue)
{
  mitk::LabelSetImage *workingImage = GetWorkingImage();
  assert(workingImage);
...
void CustomQmitkLabelSetWidget::OnItemClicked(QTableWidgetItem *item)
{
  if (!item)
    return;
...
void CustomQmitkLabelSetWidget::OnItemDoubleClicked(QTableWidgetItem *item)
{
  if (!item)
    return;
...
void CustomQmitkLabelSetWidget::SelectLabelByPixelValue(mitk::Label::PixelType pixelValue)
{
  // MITK_INFO << "CustomQmitkLabelSetWidget::SelectLabelByPixelValue " << pixelValue;
...
void CustomQmitkLabelSetWidget::InsertTableWidgetItem(mitk::Label *label)
{
...
void CustomQmitkLabelSetWidget::UpdateAllTableWidgetItems()
{
  mitk::LabelSetImage *workingImage = GetWorkingImage();
  if (!workingImage)
    return;
...
void CustomQmitkLabelSetWidget::UpdateTableWidgetItem(QTableWidgetItem *item)
{
  mitk::LabelSetImage *workingImage = GetWorkingImage();
...
void CustomQmitkLabelSetWidget::ResetAllTableWidgetItems()
{
  QTableWidget *tableWidget = m_Controls.m_LabelSetTableWidget;
  // remove all rows
...
int CustomQmitkLabelSetWidget::GetPixelValueOfSelectedItem()
{
...
QStringList &CustomQmitkLabelSetWidget::GetLabelStringList()
{
  return m_LabelStringList;
}

void CustomQmitkLabelSetWidget::InitializeTableWidget()
{
...
void CustomQmitkLabelSetWidget::OnOpacityChanged(int value)
{
  int pixelValue = GetPixelValueOfSelectedItem();
...
void CustomQmitkLabelSetWidget::setEnabled(bool enabled)
{
  QWidget::setEnabled(enabled);
  UpdateControls();
}

void CustomQmitkLabelSetWidget::SetDataStorage(mitk::DataStorage *storage)
{
  m_DataStorage = storage;
}

void CustomQmitkLabelSetWidget::OnSearchLabel()
{
...
void CustomQmitkLabelSetWidget::OnLabelListModified(const QStringList &list)
{
  QStringListModel *completeModel = static_cast<QStringListModel *>(m_Completer->model());
  completeModel->setStringList(list);
}

mitk::LabelSetImage *CustomQmitkLabelSetWidget::GetWorkingImage()
{
...
mitk::DataNode *CustomQmitkLabelSetWidget::GetWorkingNode()
{
...
void CustomQmitkLabelSetWidget::UpdateControls()
{
  mitk::DataNode *workingNode = m_ToolManager->GetWorkingData(0);
...
void CustomQmitkLabelSetWidget::OnCreateCroppedMask(bool)
{
...
void CustomQmitkLabelSetWidget::OnCreateMask(bool /*triggered*/)
{
  m_ToolManager->ActivateTool(-1);
...
void CustomQmitkLabelSetWidget::OnToggleOutline(bool value)
{
  mitk::DataNode *workingNode = m_ToolManager->GetWorkingData(0);
  assert(workingNode);
...
void CustomQmitkLabelSetWidget::OnCreateSmoothedSurface(bool /*triggered*/)
{
  m_ToolManager->ActivateTool(-1);
  ...
  itk::SimpleMemberCommand<CustomQmitkLabelSetWidget>::Pointer successCommand =
    itk::SimpleMemberCommand<CustomQmitkLabelSetWidget>::New();
  successCommand->SetCallbackFunction(this, &CustomQmitkLabelSetWidget::OnThreadedCalculationDone);
  surfaceFilter->AddObserver(mitk::ResultAvailable(), successCommand);

  itk::SimpleMemberCommand<CustomQmitkLabelSetWidget>::Pointer errorCommand =
    itk::SimpleMemberCommand<CustomQmitkLabelSetWidget>::New();
  errorCommand->SetCallbackFunction(this, &CustomQmitkLabelSetWidget::OnThreadedCalculationDone);
...
void CustomQmitkLabelSetWidget::OnCreateDetailedSurface(bool /*triggered*/)
{
  m_ToolManager->ActivateTool(-1);
...
void CustomQmitkLabelSetWidget::OnImportLabeledImage()
{
  /*
    m_ToolManager->ActivateTool(-1);
...
void CustomQmitkLabelSetWidget::OnImportSegmentation()
{
  /*
    m_ToolManager->ActivateTool(-1);
...
void CustomQmitkLabelSetWidget::WaitCursorOn()
{
  QApplication::setOverrideCursor(QCursor(Qt::WaitCursor));
}

void CustomQmitkLabelSetWidget::WaitCursorOff()
{
  this->RestoreOverrideCursor();
}

void CustomQmitkLabelSetWidget::RestoreOverrideCursor()
{
  QApplication::restoreOverrideCursor();
}

void CustomQmitkLabelSetWidget::OnThreadedCalculationDone()
{
