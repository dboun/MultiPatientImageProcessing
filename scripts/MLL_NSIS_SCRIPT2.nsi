...
Name "MLL_v0.9_Installer_Win64"

; The file to write
OutFile "MLL_v0.9_Installer_Win64.exe"

; The default installation directory
InstallDir "C:\MLL\v0.9"
...
Function CreateDeskShortcut
  ...
  CreateShortcut "$DESKTOP\MLL Semi-Automatic Segmentation.lnk" "$INSTDIR\MLL.exe" "" "$INSTDIR\MLL.exe" 0
...
Section "MLL (required)"
  ...
  ; Put file there
  File /r "*"
  Delete $INSTDIR\MLL_NSIS_SCRIPT2.nsi
